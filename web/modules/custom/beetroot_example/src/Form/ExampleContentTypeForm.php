...
/**
 * Form handler for example content type forms.
 */
class ExampleContentTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['label'] = [
      ...
      '#description' => $this->t('The human-readable name of this example content type.'),
      '#required' => TRUE,
      '#size' => 30,
    ];
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['submit']['#value'] = $this->t('Save example content type');
    $actions['delete']['#value'] = $this->t('Delete example content type');
    return $actions;
  }
