...
/**
 * Provides a list controller for the example content entity type.
 */
class ExampleContentListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new ExampleContentListBuilder object.
   *
